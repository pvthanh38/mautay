$().ready(function(){$('.lookbook .item').hover(function(){$('.lookbook .item').stop().animate({opacity:.8},300);$(this).stop().css('opacity',1);},function(){$('.lookbook .item').stop().animate({opacity:1},200);});});
