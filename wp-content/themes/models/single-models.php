<?php get_header(); 
$term = wp_get_post_terms(get_the_ID(),'object');
$terms = [];
if($term){
	$term = get_term_top_most_parent($term[0]->term_id, 'object');
	$terms = get_term_children($term->term_id, 'object');
}
//print_r($term);
?>
						...
						<?php if($term){ ?>
                                ...
                                <div class="s-block-title-left">
                                    <div class="s-block-title-right">
                                        <div class="s-block-title-bg">
                                            <h3><a href="<?php echo get_term_link($term->term_id,'object'); ?>"><?php echo $term->name ?></a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="s-block-content ver-down-cat">
								...
								foreach($terms as $t){
									$k = get_term($t,'object');
									//print_r($k);?>
                                    <li class="category"><a href="<?php echo get_term_link($k->term_id,'object'); ?>"><span><span><?php echo $k->name; ?></span></span></a></li>
                                <?php }} ?>
                                </ul>
                            </div>
                            <div class="clb"></div>
